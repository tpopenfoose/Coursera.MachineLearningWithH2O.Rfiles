...
h2o.performance(m3, valid = TRUE)
h2o.performance(m3, test)


fname <- h2o.saveModel(m3, "modelFolder")  ## will create folder for you, if it does not already exist,
                                           ## will use model id for model's file name
fname

mLoaded <- h2o.loadModel("modelFolder/earlyStop_r")  ## will use relative path
